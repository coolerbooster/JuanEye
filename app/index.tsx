...
export default function App() {
    ...
    React.useEffect(() => { requestPermission(); }, [requestPermission]);
    React.useEffect(() => { loadLabels().then(setLabels); }, []);
    ...
    if (!hasPermission || !device) return <View style={styles.center}><Text>No camera</Text></View>;
